...
our $SHORTDESCRIPTION = 'TablePlugin clone using skin templates';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{TableTmplPlugin}{ExampleSetting} = 1;
...
1;
__END__
This copyright information applies to the TableTmplPlugin:

# Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/
#
# TableTmplPlugin is # This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
